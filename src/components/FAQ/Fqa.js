...
export default function Fqa() {
    return (
        ...
        {/* <div className="fqa">
            ...
            <div className="downloadApp py-5" style={{backgroundColor : "#ff4553" }}>
                <div className="container">
                    <div className="row">
                        <div className="col">
                            <h3 className='text-white text-center fs-1'>Get a free <br />medical appointment</h3>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                            <div className="d-flex justify-content-center flex-wrap mt-5">
                                {/* <div>
                                    <button type="button" className="btn btn-outline-danger rounded-pill  mb-3 button1 ">DOWNLOAD APP</button>
                                </div> */}
                                <div>
                                    <Link to={":doctorid"} className="btn btn-outline-danger ms-3 rounded-pill text-dark  button1">BOOK APPOINMENT</Link>
                                </div>
                            </div>
                        </div>
                    </div>
