...
export default function Reviews() {
    ...
    return (
        <>
            <div className="reviewSection py-5 bg-white">
                                        ...
                                        <li>
                                            <div className="card p-3 active" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1">
                                                ...
                                                <div className="d-flex flex-row align-items-center">
                                                    ...
                                                    <img src="https://i.imgur.com/G1pXs7D.jpg" width="50" className="rounded-circle" style={{marginRight : "20px"}} />
                                        ...
                                        <li>
                                            <div className="card p-3" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                                ...
                                                <div className="d-flex flex-row align-items-center">
                                                    ...
                                                    <img src="https://i.imgur.com/udGH5tO.jpg" width="50" className="rounded-circle" style={{marginRight : "20px"}}/>
                                        ...
                                        <li>
                                            <div className="card p-3" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                                ...
                                                <div className="d-flex flex-row align-items-center">
                                                    ...
                                                    <img src="https://i.imgur.com/Uz4FjGZ.jpg" width="50" className="rounded-circle" style={{marginRight : "20px"}}/>
                                ...
                                <div className="p-3 carousel-inner">
                                    <div className="carousel-item active">
                                        <div className="card-body">
                                            <h4 className='text-dark'>It was a great experience</h4>
                                            ...
                                            <p className='text-dark'>My Wellness Medical Center has set a high standard for healthcare excellence. The combination of a welcoming atmosphere, dedicated and knowledgeable staff, and a commitment to advanced medical practices make this center a standout choice for anyone seeking top-notch healthcare services. I wholeheartedly recommend My Wellness Medical Center to anyone in search of a medical facility that prioritizes patient well-being and delivers exceptional care.</p>
                                        </div>
                                    </div>
