...
export default function Contact() {
  ...
  return (
    <div className='contact'>
      <div className="container-fluid py-5 contactForm" style={{backgroundColor : "#ff4553"}}>
        <div className="row justify-content-center " >
          <div className="col-12 col-md-8 col-lg-6 " >
            <div className="box bg-white button1 p-5">
              {
                messageResponse ?
                  <>
                    ...
                    <div className="text-center">
                      <h3>Contact Us</h3>
                      <p style={{ fontSize: "14px" , color : "black"}}>Fill out the form and send us a secure message. We will respond as soon as possible.</p>
                    </div>
                    <div className="row">
                      <div className="col-12 col-md-6 col-lg-6">
                        <div className="mb-3">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-12 col-lg-4 text-center">
                        <button onClick={handleMessage} className="btn btn-danger text-white rounded-pill button1">SEND MESSAGE</button>
                      </div>
                    </div>
                  </>
                  :
                  <>
                    <div className="row Box">
                      <div className="col ">
                        ...
                        <h3 className='text-dark'>Thanks for sending us your message.</h3>
                        <div className="d-flex justify-content-center w-100">
                        <p className=' w-75 text-dark'>We appreciate you contacting us. A member of our team will get back to you within 24 hours. Have a great day!</p>
                        </div>
                      </div>
                    </div>
      ...
      <div className="treatment">
        <div className="container mt-5 my-4">
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 col-lg-8 text-center">
              <h4 className='text-dark' >We’d love to hear from you</h4>
              <p className='w-75  text-dark' >Supporting text</p>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-4 col-lg-4" >
              <div className="card p-4 mb-4" style={{backgroundColor : "#ff4553"}}>
                <div className="imgDiv ">
                  <i className="fa-solid fa-location-dot"></i>
                </div>
                <h4 className='fs-5 text-white'>Visit Us</h4>
                <p>visit our office HQ</p>
                <p className='text-dark nav-link'>4118 Providence Lane <br /> Alhambra, CA 91801</p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-4">
              <div className="card p-4 mb-4" style={{backgroundColor : "#ff4553"}}>
                ...
                <h4 className='fs-5 text-white'>Mail us</h4>
                <p>Speak with our team</p>
                <p className='text-dark nav-link'>Support@hwmresume.com <br />Sale@hwmresume.com</p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-4">
              <div className="card p-4 mb-4" style={{backgroundColor : "#ff4553"}}>
                ...
                <h4 className='fs-5 text-white'>Call Us</h4>
                <p>Mon-Fri from 8am to 5pm</p>
                <p className='text-dark nav-link'>(+92) 326-7876344 <br />(+92) 326-7876344 </p>
              </div>
            </div>
