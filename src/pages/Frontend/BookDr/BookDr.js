                ...
                <div className="row">
                  <div className="col">
                    <div className="timeSlot mt-3">
                      <div className="head">
                        <p className=' text-white' style={{backgroundColor :"red"}} >Available Time ToDay</p>
                      </div>
                      {
                        isConfirm ?
                          <div className="body py-3">
                            ...
                            <div className="row my-2">
                              <div className="col text-center">
                                <button type="button" className="btn text-white rounded-pill px-5 " style={{backgroundColor : "red"}} onClick={handleBooking} >CONFIRM</button>
                              </div>
                            </div>
                          </div>
                          :
